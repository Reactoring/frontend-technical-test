    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          ...
          <br />
          <br />
          Get started by reading <code className={styles.code}>README.md</code> and editing{' '}
        ...
        <div className={styles.grid}>
          ...
          <article className={styles.card}>
            <h2>API Server</h2>
            <p>
              Start the API server on port <code className={styles.code}>3005</code> by running
              <br />
              <code className={styles.code}>npm run start-server</code>.<br />
              Find the swagger definitions in <code className={styles.code}>docs/api-swagger.yml</code> or{' '}
              <a
          ...
          <article className={styles.card}>
            <h2>Timing</h2>
            <p>
              We recommend 4 hours for this test. You are free to spend more (or less) time, let us know how much time
              did you spend.
            </p>
          </article>
        </div>
